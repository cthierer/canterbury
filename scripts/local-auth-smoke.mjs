...
const startProcess = (label, command, extraEnv) => {
...
const runForeground = (command, args, options) => {
...
const waitForTCP = async (address, label) => {
